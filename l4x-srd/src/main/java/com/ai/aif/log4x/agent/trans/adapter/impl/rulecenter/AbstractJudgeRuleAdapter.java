...
public class AbstractJudgeRuleAdapter extends AbsJavassistSwitchAdapter {
    @Override
    public String addAfterInvoke(CtMethod arg0, String arg1, String arg2) {
        ...
        buf.appendln("trace.addData(\"isIntercept\",\"\");");
//        buf.appendln("if(getRuleMsg().isSuccess() && (\"0\".equals(getRuleMsg().getMsgType()) || \"1\".equals(getRuleMsg().getMsgType()))){");
//        buf.appendln("trace.addData(\"isIntercept\",\"0\");");
//        buf.appendln("}else{trace.addData(\"isIntercept\",\"1\");}");
